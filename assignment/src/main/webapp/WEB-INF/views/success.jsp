...
function myFunction() {
  // Get the text field
  var copyText = document.getElementById("formGroupExampleInput2");
...
<body>
	...
	<div class="row pr-5 mx-5 px-5 pt-5">
		<div class="col-md-6 mx-5 px-5 ">
			<h2 class="text-info">
				<span class="label label-default">AES Encryption</span>
			</h2>
			<form action="modified" method="post">
				<div class="form-group mb-3  ">
					<label for="formGroupExampleInput" class="form-label fw-bold ">Plain
						...
						<small>Secret key used here is <b>my_super_secret_key_ho_ho_ho</b></small>
				</div>
				...
				<div class="mb-3">
					...
					<textarea contenteditable="true" type="text" class="form-control"
						id="formGroupExampleInput2"
						placeholder="Encrypted text will display here" readonly="readonly">${tmp }</textarea>
	...
	<div class="row pr-5 mx-5 px-5 pt-5">
		<div class="col-md-6 mx-5 px-5 ">
			<h2 class="text-info">
				<span class="label label-default">AES Decryption</span>
			</h2>
			<form action="demodified" method="post">
				<div class="form-group mb-3  ">
				...
				<div class="mb-3">
					...
					<textarea type="text" class="form-control"
						id="formGroupExampleInput2"
						placeholder="Encrypted text will display here" readonly="readonly">${dmp }</textarea>
