...
<body>
	...
	<div class="row pr-5 mx-5 px-5 pt-5">
		<div class="col-md-6 mx-5 px-5 ">
			<h2 class="text-info">
				<span class="label label-default">Base 64 Encoder</span>
			</h2>
			<form action="basechange" method="post">
				...
				<div class="form-group col-md-12">
					...
					<div class="col-sm-10">
						<button type="submit" class="btn btn-info">Encode Text</button>
					</div>
				</div>
				<div class="mb-3">
					<label for="formGroupExampleInput2" class="form-label fw-bold">Encoded
						text</label>
					<textarea type="text" class="form-control"
						id="formGroupExampleInput2"
						placeholder="Encrypted text will display here" readonly="readonly">${ben }</textarea>
				</div>
			</form>
		</div>
	</div>
	<div class="row pr-5 mx-5 px-5 pt-5">
		<div class="col-md-6 mx-5 px-5 ">
			<h2 class="text-info">
				<span class="label label-default">Base64 Decoder</span>
			</h2>
			<form action="basenotchange" method="post">
				<div class="form-group mb-3  ">
					<label for="formGroupExampleInput" class="form-label fw-bold ">Encoded
						Text</label> <input type="text" class="form-control"
						id="formGroupExampleInput" name="text"
						placeholder="Enter the plain text here">
				</div>
				<div class="form-group col-md-12">
					<label class="col-sm-2"></label>
					<div class="col-sm-10">
						<button type="submit" class="btn btn-info">Decode Data</button>
					</div>
				</div>
				<div class="mb-3">
					...
					<textarea type="text" class="form-control"
						id="formGroupExampleInput2"
						placeholder="Encrypted text will display here" readonly="readonly">${bnc }</textarea>
				</div>
			</form>
		</div>
	</div>
